...
public static partial class Permissions
{
    ...
    [DisplayName("Version Permissions")]
    [Description("Set permissions for version operations.")]
    public static class Versions
    {
        public const string View = "Permissions.Versions.View";
        public const string Create = "Permissions.Versions.Create";
        public const string Edit = "Permissions.Versions.Edit";
        public const string Delete = "Permissions.Versions.Delete";
        public const string Search = "Permissions.Versions.Search";
        public const string Export = "Permissions.Versions.Export";
        public const string Import = "Permissions.Versions.Import";
    }
