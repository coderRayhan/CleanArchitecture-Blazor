...
namespace CleanArchitecture.Blazor.Migrators.PostgreSQL.Migrations
{
    ...
    [Migration("20241223115811_SedrialNoAddedToMenu")]
    partial class SedrialNoAddedToMenu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Academic.Version", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.ApplicationInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("FatherNameBangla")
                        ...
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
                        .HasColumnName("father_name_bangla");
                    ...
                    b.Property<string>("FullNameBangla")
                        ...
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
                        .HasColumnName("full_name_bangla");
                    ...
                    b.Property<string>("MotherNameBangla")
                        ...
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
                        .HasColumnName("mother_name_bangla");
                    ...
                    b.Property<string>("SMSNotificationNo")
                        ...
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
                        .HasColumnName("sms_notification_no");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.MenuSectionItem", b =>
                {
                    ...
                    b.HasIndex("PageStatus")
                        .HasDatabaseName("ix_menu_section_items_page_status");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.MenuSectionSubItem", b =>
                {
                    ...
                    b.Property<int>("MenuSectionItemId")
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_menu_section_sub_items");

                    b.HasIndex("MenuSectionItemId")
                        .HasDatabaseName("ix_menu_section_sub_items_menu_section_item_id");

                    b.HasIndex("PageStatus")
                        .HasDatabaseName("ix_menu_section_sub_items_page_status");

                    b.ToTable("menu_section_sub_items", (string)null);
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.MenuSectionSubItem", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.MenuSectionItem", "MenuSectionItem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_menu_section_sub_items_menu_section_items_menu_section_item");
